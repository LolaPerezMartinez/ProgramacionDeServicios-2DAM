...
public class ClienteSocketNumericoNC {
	private int port;
	...
	public ClienteSocketNumericoNC(String address, int port) {
		this.port = port;
	...
	public static void main(String[] args) {
		ClienteSocketNumericoNC client = new ClienteSocketNumericoNC("localhost", 8081);
		try {
			client.start();
