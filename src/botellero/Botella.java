...
public class Botella implements Runnable{
	...
	private static long milis = 250;

	public Botella(String nombre, int capacidadMaxima, int capacidadContenida) {
		this.nombre = nombre;
	...
	public static void main(String[] args) {
		Botella b1 = new Botella("B-1", 15, 6);
		...
		Botella b2 = new Botella("B-2", 6, 4);
		Botella b3 = new Botella("B-3", 8, 4);
		Botella b4 = new Botella("B-4", 10, 5);
